...
const sidebarPages: { label: string; path: string; keywords: string[] }[] = [
  ...
  { label: "Coord. Atendimento SAC",      path: "/coordenacao/atendimento",      keywords: ["atendimento", "sac", "coordenação", "recepção", "triagem"] },
  { label: "Coord. Comunicação",          path: "/coordenacao/comunicacao",      keywords: ["comunicação", "mídia", "coordenação"] },
  { label: "Coord. Inteligência",         path: "/coordenacao/inteligencia",     keywords: ["inteligência", "dados", "coordenação"] },
  ...
  { label: "Coord. Articulação Política", path: "/coordenacao/articulacao",      keywords: ["articulação", "política", "coordenação"] },
  { label: "Coord. Legislativo",          path: "/coordenacao/legislativo",      keywords: ["legislativo", "plenária", "coordenação"] },
  { label: "Setor Saúde",                 path: "/movimentos/saude",             keywords: ["saúde", "setor", "demanda"] },
  { label: "Setor TEA",                   path: "/movimentos/tea",               keywords: ["tea", "autismo", "setor"] },
  { label: "Setor Assistência Social",    path: "/movimentos/assistencia-social",keywords: ["assistência", "social", "setor"] },
  { label: "Setor Infraestrutura",        path: "/movimentos/infraestrutura",    keywords: ["infraestrutura", "obras", "setor"] },
  { label: "Setor Empreendedorismo",      path: "/movimentos/empreendedorismo",  keywords: ["empreendedorismo", "negócios", "setor"] },
  { label: "Setor Habitação",             path: "/movimentos/habitacao",         keywords: ["habitação", "moradia", "setor"] },
  { label: "Setor Esporte e Lazer",       path: "/movimentos/esporte-lazer",     keywords: ["esporte", "lazer", "setor"] },
];
